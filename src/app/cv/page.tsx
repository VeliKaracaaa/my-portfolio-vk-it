  ...
  experiences: [
    {
      ...
      tasks: [
        "E-commerce complet avec un back-office robuste et un front-end entièrement sur mesure (Node.js, PostgreSQL, Next.js, Tailwind, shadcn/ui, framer motion, vercel).",
        "Logiciels BTP : Outil de gestion de chantier et suivi de production en temps réel dédié aux artisans du bâtiment. Simplification des processus complexes (Next.js, Supabase, vercel).",
        "Sites Vitrines : Création d'interfaces haute performance moderne.",
      ],
    },
    {
  ...
  stack: [
    {
      ...
      items: ["JavaScript", "TypeScript", "PHP", "C/C++", "HTML", "CSS"],
    },
    {
    ...
    {
      title: "Back-End & Serverless",
      items: ["Node.js", "Express.js", "Laravel", "Supabase", "Firebase"],
    },
    {
      title: "Bases de Données",
